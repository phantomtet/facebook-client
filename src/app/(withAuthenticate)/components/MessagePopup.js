  ...
  return (
    <div
      style={{
        ...
        bottom: 0,
        right: 0,
        zIndex: "var(--z-index-navigate-bar)",
      }}
    >
      <div
        style={{
      ...
      >
        <div
          ...
          style={{
            ...
            height: 48,
            background: "white",
            boxShadow: "rgba(150,150,150,0.5) 1px 1px 10px 1px",
          }}
        >
          <svg
            width="48"
...
const OpeningItem = ({ data }) => {
  ...
  useEffect(() => {
    if (isLoading)
      api
        .GET_MESSAGE(data._id, { after: messages[0]?._id })
        .then((res) => {
  ...
  useEffect(() => {
    ...
    ws.current.addEventListener("message", (e) => {
      ...
      if (
        response.eventName == "receiveMessage" &&
        response.targetId == data._id
      )
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "rgba(150,150,150,0.35) 1px 1px 10px 0.25px",
        marginLeft: 10,
      }}
    >
      <div
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "var(--secondary-icon)" }}>
              Active now
            </div>
          </div>
        </div>
        <div role="action">
          <div style={{ display: "flex" }}>
            ...
            <svg
              onClick={() =>
                dispatch(messagePopupSlice.actions.closePopup(data._id))
              }
              className="setting-button"
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                ...
                <path
                  d="M6 11H18V13H6V11Z"
                  fill={
                    isActive ? "var(--primary-color)" : "var(--icon-inactive)"
                  }
                />{" "}
              </g>
            </svg>
      ...
      >
        <svg
          ...
          style={{
            ...
            margin: 6,
            minWidth: 20,
            fill: isActive ? "var(--primary-color)" : "var(--icon-inactive)",
          }}
          height="20px"
          viewBox="0 0 24 24"
          width="20px"
        ...
        <svg
          ...
          style={{
            borderRadius: "100%",
            padding: 0,
            margin: input.content == "" ? 6 : 0,
            minWidth: input.content == "" ? 20 : 0,
            width: 0,
            fill: isActive ? "var(--primary-color)" : "var(--icon-inactive)",
          }}
          width="22"
...
const MessageItem = ({ data }) => {
  ...
  return (
    <div
      style={{
        display: "flex",
        justifyContent: isYourMessage ? "right" : "left",
        alignItems: "center",
      }}
    >
      <img
        hidden={isYourMessage}
        src={data.owner.avatar}
        style={{ height: 28, width: 28, borderRadius: "100%", marginRight: 8 }}
      />
      <div
        style={{
          display: "inline-flex",
          ...
          margin: 1,
          borderRadius: 20,
          background: isYourMessage ? "var(--primary-color)" : "var(--gray)",
...
const ClosingItem = ({ data }) => {
  ...
  return (
    <div className="hover-show-hidden" style={{ position: "relative" }}>
      <img
        onClick={() => dispatch(messagePopupSlice.actions.openPopup(data._id))}
        style={{
          cursor: "pointer",
          height: 48,
          width: 48,
      ...
      <svg
        ...
        className="setting-button hidden"
        style={{
          borderRadius: "100%",
          padding: 0,
          background: "white",
