...
const OpeningItem = ({ data }) => {
    ...
    const ref = useRef()
    useEffect(() => {
        if (isActive) ref.current.getElementsByTagName('input')[0].focus()
    ...
    return (
        <div ref={ref} onClick={() => setIsActive(true)} style={{ height: 455, width: 328, background: 'white', borderRadius: '8px 8px 0 0', boxShadow: 'rgba(150,150,150,0.35) 1px 1px 10px 0.25px', marginLeft: 10 }}>
            ...
            <div role='message' style={{ height: 347, overflowY: 'scroll' }}>
                <div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div><div>adad</div>
            </div>
            <div role='input' style={{ height: 60, marginTop: 5, display: 'flex', alignItems: 'center' }} >
                ...
                <input placeholder="Aa" value={input.content} onChange={e => setInput(prev => ({ ...prev, content: e.target.value }))} />
