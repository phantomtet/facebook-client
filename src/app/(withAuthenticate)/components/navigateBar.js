...
const CenterNavigateBar = () => {
    ...
    return (
        <ul style={{ display: 'flex', position: 'absolute', transform: 'translateX(-50%)', left: '50%', height: '100%' }}>
            <Link href='/'>
                <li className="setting-button" style={{ height: '100%', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 3px', borderBottom: '3px solid', minWidth: 111, borderColor: pathname == '/' ? 'var(--primary-color)' : 'transparent' }}>
            ...
            <Link href='/watch'>
                <li className="setting-button" style={{ height: '100%', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 3px', borderBottom: '3px solid', minWidth: 111, borderColor: pathname == '/watch' ? 'var(--primary-color)' : 'transparent' }}>
            ...
            <Link href='/marketplace'>
                <li className="setting-button" style={{ height: '100%', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 3px', borderBottom: '3px solid', minWidth: 111, borderColor: pathname == '/marketplace' ? 'var(--primary-color)' : 'transparent' }}>
            ...
            <Link href='/groups'>
                <li className="setting-button" style={{ height: '100%', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 3px', borderBottom: '3px solid', minWidth: 111, borderColor: pathname == '/groups' ? 'var(--primary-color)' : 'transparent' }}>
            ...
            <Link href='/wadafak'>
                <li className="setting-button" style={{ height: '100%', borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 3px', borderBottom: '3px solid', minWidth: 111, borderColor: pathname == '/wadafak' ? 'var(--primary-color)' : 'transparent' }}>
