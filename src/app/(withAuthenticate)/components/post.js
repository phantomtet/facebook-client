        ...
        <div className="comment" style={{ display: 'flex', }}>
            ...
            <div>
                ...
                <div className="reaction" style={{ display: 'flex', fontSize: 12, padding: '0 8px', margin: '2px 0', color: 'var(--text-gray-color)' }}>
                    <span style={{ marginRight: 10, fontWeight: 600, cursor: 'pointer' }}>Like</span>
                    <span style={{ marginRight: 10, fontWeight: 600, cursor: 'pointer' }}>Reply</span>
                    <span title={dayjs(data.createdAt).format('dddd, MMMM DD, YYYY [at] hh:mm A')}>{getDifferentTime(data.createdAt)}</span>
                </div>
            </div>
    ...
    return (
        <>
            ...
            <div onMouseEnter={showPopup} onMouseLeave={hidePopup}
                ...
                <img onMouseUp={(e) => e.button == 0 && handleClick(4)} className="react-icon" src='/react-icon-4.png' />
                <img onMouseUp={(e) => e.button == 0 && handleClick(5)} className="react-icon" src='/react-icon-5.png' />
                <img onMouseUp={(e) => e.button == 0 && handleClick(6)} className="react-icon" src='/react-icon-6.png' />
                <img onMouseUp={(e) => e.button == 0 && handleClick(7)} className="react-icon" src='/react-icon-7.png' />
            </div>
        </>
    )
}
